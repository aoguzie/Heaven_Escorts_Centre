			...
			<div class="flex-w flex-tr">
				<div class="size-210 bor10 p-lr-70 p-t-55 p-b-70 p-lr-15-lg w-full-md" style="margin: 0 auto;">
					<form name="frm" method="post" action="control/reset-password.php">
						<h4 class="mtext-105 cl2 txt-center p-b-20" style="color: #209900;">
							Your message has been sent to LiamCoins Customer Service.
						</h4>
						<p class="text-center p-b-20">You should receive a response within 24-48 hours.</p>
					</form>
