...
<html lang="en">
<head>
	<title>Change Password Congratulations!</title>
			...
			<div class="flex-w flex-tr">
				<div class="size-210 bor10 p-lr-70 p-t-55 p-b-70 p-lr-15-lg w-full-md" style="margin: 0 auto;">
					<form name="frm" method="post" action="control/reset-password.php">
						...
						<p class="text-center p-b-20">Your password has been reset.</p>

						<a href="index.php"><button type="button" class="flex-c-m stext-101 cl0 size-121 bg3 bor1 hov-btn3 p-lr-15 trans-04 pointer">
							Continue Shopping
						</button></a>
