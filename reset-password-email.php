			...
			<div class="flex-w flex-tr">
				<div class="size-210 bor10 p-lr-70 p-t-55 p-b-70 p-lr-15-lg w-full-md" style="margin: 0 auto;">
					<form name="frm" method="post" action="control/reset-password-send.php">
						...
						<p class="text-center p-b-20">We sent you an email with instructions on how to<br>confirm your identity in order to access your account. <br>The email expires in 24 hours.</p>
